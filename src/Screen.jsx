      ...
      <div className="customContainer">
        <div className="row">
          <div className="col-md-6 col-12">
            <div className="row">
              <div className="col-md-5 roundImage">
                {file ? (
          ...
          <div className="col-md-6 customPadding">
                ...
                <div className='container'>
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 col-6"><BsTrash onClick={handleDelete} className='icon' color='#025EE5' size={50} /></div>
            ...
            <div className="container">
              <div className="row">
                {!mode && (<><div className="col-md-6 col-6" style={{ textAlign: "center" }}><FaEdit onClick={handleEdit} className='icon' color='#025EE5' size={50} /></div>
                  <div className="col-md-6 col-6"><BsTrash onClick={handleDelete} className='icon' color='#025EE5' size={50} /></div>
                </>
                )}
              </div>
